...
import com.yd.ye.R;
import com.yd.ye.main.fragments.HomeFragment;
import com.yd.ye.main.fragments.MeFragment;
import com.yd.ye.main.fragments.Tab1Fragment;
import com.yd.ye.main.fragments.Tab2Fragment;
import com.yd.ye.main.fragments.Tab3Fragment;
...
public class MainPagerAdapter extends FragmentPagerAdapter {
    ...
    public MainPagerAdapter(FragmentManager fm) {
        ...
        if (PAGE_CONFIG.showHome) {
            ...
            norIcons[lastIndex] = R.drawable.shouan;
            seleIcons[lastIndex] = R.drawable.shouyeliang;
        }
        if (PAGE_CONFIG.showClassify) {
            list.add(new Tab1Fragment());
            int lastIndex = list.size() - 1;
            titles[lastIndex] = R.string.main_tab_classify;
            norIcons[lastIndex] = R.drawable.onean;
            seleIcons[lastIndex] = R.drawable.oneliang;
        }
...
//        }
        if (PAGE_CONFIG.showMe) {
            ...
            norIcons[lastIndex] = R.drawable.mean;
            seleIcons[lastIndex] = R.drawable.meliang;
        }
    }
