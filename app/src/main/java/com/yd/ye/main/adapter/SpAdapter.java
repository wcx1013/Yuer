...
public class SpAdapter extends RecyclerView.Adapter {
    ...
    public SpAdapter(ArrayList<ScxiangyinBean.ListBean> listBeans,  Context context) {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            name1 = itemView.findViewById(R.id.tv);
            //     name2 = itemView.findViewById(R.id.tv2);
            imd = itemView.findViewById(R.id.ims);
    ...
    public void setJiekouhuidiaos(SpAdapter.Jiekouhuidiao jiekouhuidiao) {
