...
public class SelectDialog  extends Dialog implements View.OnClickListener, AdapterView.OnItemClickListener {
     ...
     * @param names          菜单项名称
     */
    public SelectDialog(Activity activity, int theme, SelectDialogListener listener, SelectDialogCancelListener cancelListener,
                        List<String> names)
    {
        super(activity, theme);
        mActivity = activity;
    ...
    private void initViews()
    {
        ...
        mMBtn_Cancel = (TextView) findViewById(R.id.mBtn_Cancel);
    ...
    private class DialogAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if ("删除".equals(mStrings.get(position))) {
                viewholder.dialogItemButton.setTextColor(R.color.color_ff4444);
            } else {
                viewholder.dialogItemButton.setTextColor(R.color.color_242424);
            }
            //设置字体颜色ResUtil.getColor(R.color.color_242424)
           /* if (!mUseCustomColor)
            {
